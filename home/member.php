...
<div id="main-content" style="width: 1000px; text-align: left; margin-left: 210px;"> 
...
<tr> 
<th> 
<h3>Member Registration form</h3> </th> 
</tr> 
<tr> 
...
<td><input type="file" name="customer-pic" id="customer-pic"/></td>
</tr>
</table> 
<?php include_once('buttons.php'); ?>
</form> 
</div> 
<div id="right-div" style="float: left; width: 50%;">
<img src="../images/tn_no-image.jpg" id="image" alt="cutomer pic" width="300px" height="300px"/>
</div>
</div><!--main-div-->
